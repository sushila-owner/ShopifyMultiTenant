...
const GIGAB2B_CATEGORY_KEYWORDS: CategoryKeywords[] = [
  { categoryName: "Sofas", keywords: ["sofa", "couch", "sectional", "loveseat", "settee", "divan", "futon sofa", "sleeper sofa", "chesterfield", "modular sofa", "cloud couch", "chaise"], excludeKeywords: ["sofa table", "sofa cover", "sofa leg"] },
  ...
  { categoryName: "Cabinets", keywords: ["cabinet", "cupboard", "sideboard", "buffet cabinet", "display cabinet", "china cabinet", "bar cabinet", "storage cabinet", "file cabinet", "dresser", "vanity", "makeup vanity", "drawer", "drawers", "chest of drawers", "tallboy", "highboy", "lowboy", "console", "credenza", "hutch", "mirror"], excludeKeywords: ["cabinet hardware", "cabinet knob"] },
...
const SHOPIFY_CATEGORY_KEYWORDS: CategoryKeywords[] = [
  { categoryName: "Designer Clothing", keywords: ["clothing", "dress", "shirt", "blouse", "jacket", "coat", "sweater", "cardigan", "pants", "trousers", "jeans", "skirt", "suit", "blazer", "vest", "top", "t-shirt", "hoodie", "polo", "knitwear", "outerwear", "designer", "bathrobe", "robe", "underwear", "lingerie", "bra", "panty", "panties", "briefs", "boxer", "boxers", "thong", "t-back", "t-backs", "bodysuit", "corset", "nightgown", "pajama", "pajamas", "pyjama", "pyjamas", "sleepwear", "loungewear", "petticoat", "jumper", "jumpsuit", "romper", "leggings", "shorts", "crop", "tunic", "kimono", "poncho", "cape", "gown", "maxi", "mini", "midi", "cocktail", "evening", "formal", "casual", "set", "figl", "kalimo", "tessita"], excludeKeywords: ["shoe", "bag", "watch", "jewelry", "perfume", "fragrance"] },
